...
import 'package:pesafy_marketer/views/home/add_clients3.dart';
...
class _ViewClientsState extends State<ViewClients> {
  ...
  Future<List<User>> fetchUsers() async {
    final response = await http.get(Uri.parse('http://api.pesafy.africa/marketers/get_users.php'));
    if (response.statusCode == 200) {
      final List<dynamic> jsonList = jsonDecode(response.body);
      final filteredJsonList = jsonList.where((userJson) => userJson['userRole'] == 'customer service').toList();
      final users =
                      ...
                      return Stack(
                        children: [
                          ...
                          Positioned(
                            ...
                            child: TextButton(
                              onPressed: () async {
                                TextEditingController user_assignedController =
