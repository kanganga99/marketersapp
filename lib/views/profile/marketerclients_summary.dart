      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            int firstTimeCount = data.where((client) => client['acquisition'] == 'First Time').length;
            int interestedCount = data.where((client) => client['acquisition'] == 'Interested').length;
            int onBoardedCount = data.where((client) => client['acquisition'] == 'On Boarded').length;
            return Column(
              children: [
                Padding(
